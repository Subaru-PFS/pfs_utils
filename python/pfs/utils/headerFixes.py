...
class HeaderFixDatabase:
    ...
    def addStandardFixes(self):
        ...
        # Engineering run #12 in July 2023.
        self.add("S", [96892, 96893], W_AITQTH=False)
        self.add("S", self.inclRange(97246, 97250), W_AITQTH=False)
        self.add("S", [97252, 97253], W_AITQTH=False)
        self.add("S", self.inclRange(97255, 97262), W_AITQTH=False)
        self.add("S", self.inclRange(97264, 97271), W_AITQTH=False)
        self.add("S", self.inclRange(97273, 97280), W_AITQTH=False)
        self.add("S", self.inclRange(97283, 97290), W_AITQTH=False)
        self.add("S", self.inclRange(97292, 97301), W_AITQTH=False)
        self.add("S", [97303, 97304], W_AITQTH=False)
        self.add("S", self.inclRange(97306, 97314), W_AITQTH=False)
        self.add("S", self.inclRange(97316, 97323), W_AITQTH=False)
        self.add("S", self.inclRange(97325, 97332), W_AITQTH=False)
        self.add("S", self.inclRange(97334, 97341), W_AITQTH=False)
        self.add("S", [97343], W_AITQTH=False)
        self.add("S", self.inclRange(97346, 97353), W_AITQTH=False)
        self.add("S", self.inclRange(97355, 97362), W_AITQTH=False)
        self.add("S", self.inclRange(97365, 97372), W_AITQTH=False)
        self.add("S", self.inclRange(97374, 97379), W_AITQTH=False)
        self.add("S", self.inclRange(97383, 97388), W_AITQTH=False)
        self.add("S", [97484, 97485], W_AITQTH=False)

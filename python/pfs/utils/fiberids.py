...
class FiberIds(object):
    ...
    def fiberIdToMTP(self, fiberIds, pfsConfig=None):
        ...
        and cobraId is the 1-indexed global cobra ID
        ...
        assert np.all(np.arange(len(self.fiberId)) == self.fiberId - 1)
    ...
    def splitConnector(connectorName):
        ...
        fields[-1] = fields[-1] if fields[-1] == "x" else int(fields[-1])

...
agcent_off = [[-0.421, 1.036, -0.253368], [-0.164, 0.163, 0.391505],
              [-0.388, -0.339, 0.2755336], [0.323, -0.219, 0.416894],
              [0.341, -0.044, -0.0781999], [0.260, 0.194, 0.276977]]
...
class Coeff:
    ...
    def extra_distortion(self, za, inr, x, y):
        ...
        coeffs_matrix_x = np.array([[-1.53332504e-03,  1.87195111e-06, -9.59107515e-07,  
                                      2.99981468e-09,  4.34173422e-11, -1.49198635e-13, 
                                     -4.08290446e-16,  1.98415549e-18],
                                    [-8.35762339e-07, -4.51524547e-06, -2.73775737e-09,  
                                     3.01443762e-10,  1.41692906e-13, -9.19664869e-15, 
                                     -1.41000668e-18,  6.78322773e-20],
                                    [ 1.80925126e-06,  6.53134312e-09, -1.00816077e-10,
                                      -1.43740979e-12,  3.48446504e-15,  8.07751242e-17, 
                                      -6.05498342e-20, -1.20587878e-21],
                                    [-1.92510731e-09,  2.81632820e-10,  1.01502886e-12, 
                                     -3.52367155e-14, -4.12496204e-17,  8.97168070e-19,  
                                     4.24768757e-22,  1.28126210e-24],
                                    [-7.73303476e-11, -4.06749273e-13,  5.06847509e-15, 
                                      1.01530257e-16, -1.74936889e-19, -6.57101617e-21,  
                                      2.76317135e-24,  1.05344607e-25],
                                    [ 6.96300649e-14, -8.67404065e-15, -5.03422328e-17, 
                                      1.05719973e-18,  1.75756622e-21, -4.17688593e-24, 
                                     -1.09474287e-26, -8.81087009e-28],
                                    [ 8.02314547e-16,  6.47612384e-18, -3.33466301e-20, 
                                     -1.81488233e-21,  1.77059324e-24,  1.26271329e-25, 
                                     -3.92235788e-29, -2.00732438e-30],
                                    [-3.19923337e-19,  7.66340884e-20,  6.04269663e-22,
                                     -5.25942848e-24, -1.82428226e-26, -6.76067546e-28, 
                                      6.66859805e-32,  2.95072421e-32]])
        coeffs_matrix_y = np.array([[ 2.74843321e-02, -2.16570791e-05, -3.05692321e-06,  
                                      2.79338930e-09,  2.49037454e-11, -1.25940602e-13, 
                                     -1.02770332e-16,  1.75220122e-18],
                                    [ 1.19823754e-05,  4.71948079e-06, -4.13433588e-10, 
                                     -4.64359857e-10,  4.85588520e-14,  1.58078146e-14, 
                                     -1.41687626e-18, -1.69386768e-19],
                                    [-2.87402674e-07,  1.44254534e-09,  1.13611197e-10, 
                                      1.73943153e-13, -7.08965213e-15, -7.52479777e-18, 
                                      9.64284434e-20,  1.00260919e-22],
                                    [ 1.92564840e-09, -4.80805373e-10, -3.20761305e-13, 
                                      6.64711501e-14,  2.43498434e-17, -2.72958713e-18, 
                                     -4.35529539e-22,  3.19793350e-23],
                                    [-5.80443860e-12,  3.96324889e-14, -9.98684317e-15, 
                                     -1.21242678e-17,  6.90953936e-19,  2.30047721e-22, 
                                     -1.11034811e-23, -6.20480046e-27],
                                    [-8.33355355e-14,  1.67088407e-14,  1.01034343e-17,
                                     -2.87942590e-18, -5.82397262e-22,  1.26944642e-22,  
                                      9.52585668e-27, -1.53732835e-27],
                                    [-6.67016149e-17, -1.31026630e-18,  2.03882104e-19,  
                                      2.15744921e-22, -1.45769866e-23, -1.01649099e-26,  
                                      2.87520023e-28,  5.13675740e-31],
                                    [ 1.10152714e-18, -1.89963928e-19, -5.00246861e-23,  
                                      3.90342107e-23, -6.28164074e-27, -1.86871216e-27,  
                                      1.80603387e-31,  2.51597632e-32]])
        ...
        # residual: slope
        coeffs2_matrix_x, coeffs2_matrix_y = self.extra_slope_coeff(za)
        ...
        # Median of shift
        c_shiftx = np.array([1.08352478e-08,  4.05903700e-08, -6.32151149e-05, 1.76593801e-03, 0.])
        c_shifty = np.array([4.39128406e-07, -5.35996061e-05,  1.58049961e-03,  2.12912506e-03, 0.])
        extra_shift_x = np.poly1d(c_shiftx)(za)
        extra_shift_y = np.poly1d(c_shifty)(za)
    ...
    def extra_slope_coeff(self, za):
        ...
        cx0_fit=np.array([-2.40365363e-09,  2.72824666e-07, -8.63751144e-06,  6.07386917e-05, 0.00000000e+00])
        cx1_fit=np.array([ 2.51604774e-13,  4.30360835e-10, -7.37905946e-08,  3.25271321e-06, 0.00000000e+00])
        cx2_fit=np.array([-3.77114414e-12, -1.19072287e-09,  1.99819961e-07, -6.83260078e-06, 0.00000000e+00])
        cx3_fit=np.array([ 4.02052622e-13, -5.18022803e-11,  2.08593756e-09, -2.62830043e-08, 0.00000000e+00])
        cy0_fit=np.array([-6.57258003e-09,  8.04261491e-07, -2.80607731e-05, -1.65072557e-04, 0.00000000e+00])
        cy1_fit=np.array([ 1.12030711e-11, -1.33698541e-09,  8.02866932e-08, -2.17346297e-06, 0.00000000e+00])
        cy2_fit=np.array([ 5.11986087e-11, -6.44167819e-09,  2.78133733e-07, -3.95248671e-06, 0.00000000e+00])
        cy3_fit=np.array([ 2.71828312e-14, -3.52007830e-13, -1.82790694e-10,  6.57522552e-09, 0.00000000e+00])

        coeffs2_matrix_x = np.array([[np.poly1d(cx0_fit)(za), np.poly1d(cx1_fit)(za)],
                                     [np.poly1d(cx2_fit)(za), np.poly1d(cx3_fit)(za)]])

        coeffs2_matrix_y = np.array([[np.poly1d(cy0_fit)(za), np.poly1d(cy1_fit)(za)],
    ...
    def extra_distortion_sky(self, za, inr, x, y, order=1):
        ...
        coeffs_x0 = np.array([[-8.13451627e-03, -4.13444883e-05, -1.55335643e-08, -6.84723872e-10],
                              [-4.86472724e-05, -5.62985617e-08,  3.26027357e-10, -6.50046561e-12],
                              [ 3.14852694e-07, -4.76930760e-10,  4.16382033e-12,  5.82449554e-14],
                              [ 1.85296521e-09, -1.63675906e-12,  7.22475396e-14,  4.16943498e-17]])
        coeffs_y0 = np.array([[-3.44081338e-03, -5.56945955e-05, -1.96383110e-07,  1.12099433e-09],
                              [ 5.14767184e-05,  1.47253645e-07, -1.07550914e-09,  7.14042248e-12],
                              [ 1.02888652e-07,  1.04511597e-09, -1.03032887e-12,  6.81408212e-14],
                              [ 3.66381892e-10,  1.09781184e-11,  4.62848188e-14, -8.38881102e-16]])

        # 1 * inr, 1st order of polynomial
        coeffs_x1 = np.array([[-6.48101517e-03, -1.46651869e-06],
                              [-2.32767250e-07,  1.68316179e-07]])
        coeffs_y1 = np.array([[-6.24121485e-04, -5.01757483e-06],
                              [-4.66726868e-07,  3.06740902e-08]])


        # 2 * inr, 3rd order of polynomial
        coeffs_x2 = np.array([[ 6.41820388e-04,  1.93496234e-06, -2.89687690e-09,  -1.30231410e-10],
                              [-9.95618360e-06,  4.91405549e-08,  4.65040258e-10,  -5.04811551e-13],
                              [ 2.65730570e-08, -3.19346772e-10,  3.26917592e-12,   6.01546812e-15],
                              [ 3.42853817e-10, -1.15567449e-11, -6.80724137e-15,   5.15452159e-16]])
        coeffs_y2 = np.array([[ 4.65150322e-03,  1.39480209e-05, -1.52421488e-07,  -8.75535837e-10],
                              [-4.86169243e-06, -1.26947418e-07,  6.85970565e-10,   1.35412218e-11],
                              [-1.16945983e-07, -5.44052208e-10,  1.05035711e-11,   6.60497592e-14],
                              [ 8.20292934e-11,  1.36688266e-11, -2.91025646e-14,  -1.14105841e-15]])
